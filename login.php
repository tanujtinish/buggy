...
<html lang="en">
	...
	<body id="mainbody">
		...
		<a href="hrlogin.php"><button class="btn btn-default btn-success" style="position:absolute; right:0;">HR Login</button></a> 
		...
		<form id="loginform" action="loginb.php" method="post" >
			...
			<button class="btn btn-default"><a href="signup.php">Sign Up</button>
			<button class="btn btn-default"><a href="forgotlogin1.php">Forgot Password</a></button>
		</form>
